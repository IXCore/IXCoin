...
public:
    ...
    bool BatchWrite(CCoinsMap &mapCoins, CAmount miningFund, const uint256 &hashBlock) override;
...
public:
    ...
    bool BatchWrite(CCoinsMap &mapCoins, CAmount miningFundIn, const uint256 &hashBlock) override;
    CCoinsViewCursor* Cursor() const override {
