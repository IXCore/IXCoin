...
// ixcoin not changed to 60 for slightly faster propogation with some scalability impact
...
CAmount GetMiningFundSubsidy(int nHeight, const CCoinsView& view, const Consensus::Params& consensusParams);
